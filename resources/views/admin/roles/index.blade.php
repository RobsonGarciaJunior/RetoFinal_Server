                ...
                <div class="card mt-3">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button onclick="confirmCreate('{{ route('admin.roles.create') }}')" class="btn btn-success">
                                    ...
                                    <div>
                                        <form id="deleteForm_{{ $role->id }}"
                                            ...
                                            <button class="btn btn-warning" type="button"
                                                onclick="confirmEdit('deleteForm_{{ $role->id }}', '{{ route('admin.roles.edit', ['role' => $role]) }}')">
    ...
    <div class="modal" tabindex="-1" role="dialog" style="display:none" id="editModal">
        ...
        <script>
            function confirmDelete(formId) {
                ...
                var modalTitle = "{{ trans('app.delete_role') }}";
                var modalBody = "{{ trans('app.delete_role_ask') }}";
