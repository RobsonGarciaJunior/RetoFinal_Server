                ...
                <div class="card mt-3">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button onclick="confirmCreate('{{ route('admin.degrees.create') }}')" class="btn btn-success">
                                    ...
                                    <div>
                                        <form id="deleteForm_{{ $degree->id }}"
                                            ...
                                            <button class="btn btn-warning" type="button"
                                                onclick="confirmEdit('deleteForm_{{ $degree->id }}', '{{ route('admin.degrees.edit', ['degree' => $degree]) }}')">
    ...
    <div class="modal" tabindex="-1" role="dialog" style="display:none" id="editModal">
        ...
        <script>
            function confirmDelete(formId) {
                ...
                var modalTitle = "{{ trans('app.delete_degree') }}";
                var modalBody = "{{ trans('app.delete_degree_ask') }}";
